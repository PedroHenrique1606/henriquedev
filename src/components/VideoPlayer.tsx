...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ sourceVideo, posterImage, titleOfVideo, subtitleOfVideo }) => {
    const videoProps = {
        src: [
            {
                src: sourceVideo,
        ...
        onProgress: (currentTime: number) => console.log(`Current Time: ${currentTime}`),
        ...
        onPlaybackRateChange: (rate: number) => console.log(`Playback Rate: ${rate}`),
